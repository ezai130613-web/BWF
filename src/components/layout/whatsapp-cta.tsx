...
export function WhatsAppCta() {
  ...
  return (
    <TrackedAnchor
      ...
      className="fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-gold-500 text-emerald-950 shadow-lg shadow-black/30 transition-transform hover:scale-105"
    >
