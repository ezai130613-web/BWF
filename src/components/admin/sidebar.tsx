...
const NAV_ITEMS = [
  ...
  { href: "/admin/marketing/create", label: "Content Creation", permission: "marketing:manage", workspace: "marketing" },
  { href: "/admin/marketing/schedule", label: "Scheduling", permission: "marketing:manage", workspace: "marketing" },
  { href: "/admin/marketing/scripts", label: "Script Writing", permission: "marketing:manage", workspace: "marketing" },
