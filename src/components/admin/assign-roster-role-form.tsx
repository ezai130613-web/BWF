...
import { assignRosterRole } from "@/app/admin/(dashboard)/chapters/actions";

const initialState: { error?: string } = {};

export function AssignRosterRoleForm({
  chapterId,
  members,
  roles,
}: {
  ...
  const [state, formAction, pending] = useActionState(assignRosterRole, initialState);
